 ...
 *
 *  params:
 *    -i benchmarks/benchmark_Tue_Dec_15_22:44:00_2020/benchmark_0.c, -I ../liblfds7.1.1/liblfds711/inc, --unwind 5, --cex , --debug , --rounds 3, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[9] __cs_thread_lines[3] = {375, 181, 181};
...
tthread2_0_178: IF(2,178,tthread2_0_179)
                                        ...
                                        ;
                                                                ;
                                        goto __exit__lfds711_stack_push_6;
                                                                ;
                                        __exit__lfds711_stack_push_6:
                                                                __CPROVER_assume(__cs_pc_cs[2] >= 179);
                                        ;
                                                                ;
                                                        }
...
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_check_ids = (int *) __cs_safe_malloc((sizeof(int)) * 6);
...
tmain_6: IF(0,6,tmain_7)
                                        ...
                                        __cs_param_dump_structure_size = 6;
...
tmain_374: IF(0,374,tmain_375)
                                        assert(((((((__cs_local_check_size == 6) && (__cs_local_check_ids[0] == 1)) && (__cs_local_check_ids[1] == 1)) && (__cs_local_check_ids[2] == 1)) && (__cs_local_check_ids[3] == 1)) && (__cs_local_check_ids[4] == 1)) && (__cs_local_check_ids[5] == 1));
                                        __exit__check_1:
