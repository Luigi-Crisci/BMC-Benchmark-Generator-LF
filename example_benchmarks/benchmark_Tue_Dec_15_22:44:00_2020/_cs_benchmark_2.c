 ...
 *
 *  params:
 *    -i benchmarks/benchmark_Tue_Dec_15_22:44:00_2020/benchmark_2.c, -I ../liblfds7.1.1/liblfds711/inc, --unwind 5, --cex , --debug , --rounds 3, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[9] __cs_thread_lines[3] = {375, 181, 196};
