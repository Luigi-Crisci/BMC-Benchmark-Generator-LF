 ...
 *
 *  params:
 *    -i benchmarks/benchmark_Tue_Dec_15_22:44:00_2020/benchmark_31.c, -I ../liblfds7.1.1/liblfds711/inc, --unwind 5, --cex , --debug , --rounds 3, 
 *
 */
...
tthread1_0_167: IF(1,167,tthread1_0_168)
                                        __CPROVER_assume(!(__cs_local_exponential_backoff_loop < 3));
                                        __exit_loop_18:
                                                                                        __CPROVER_assume(__cs_pc_cs[1] >= 168);
                                        ;
                                                                                        ;
...
tthread1_0_170: IF(1,170,tthread1_0_171)
                                        *__cs_param_lfds711_stack_pop_se = 0;
                                        ...
                                        __CPROVER_assume(__cs_pc_cs[1] >= 171);
                                                                        ;
