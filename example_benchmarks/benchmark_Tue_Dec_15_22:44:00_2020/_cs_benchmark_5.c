 ...
 *
 *  params:
 *    -i benchmarks/benchmark_Tue_Dec_15_22:44:00_2020/benchmark_5.c, -I ../liblfds7.1.1/liblfds711/inc, --unwind 5, --cex , --debug , --rounds 3, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[9] __cs_thread_lines[3] = {375, 181, 211};
...
tmain_374: IF(0,374,tmain_375)
                                        assert((((((((((((__cs_local_check_size == 2) && (__cs_local_check_ids[0] == 1)) && (__cs_local_check_ids[1] == 1)) || (((__cs_local_check_size == 2) && (__cs_local_check_ids[3] == 1)) && (__cs_local_check_ids[1] == 1))) || ((((__cs_local_check_size == 3) && (__cs_local_check_ids[0] == 1)) && (__cs_local_check_ids[1] == 1)) && (__cs_local_check_ids[2] == 1))) || (((__cs_local_check_size == 2) && (__cs_local_check_ids[0] == 1)) && (__cs_local_check_ids[2] == 1))) || (((__cs_local_check_size == 2) && (__cs_local_check_ids[1] == 1)) && (__cs_local_check_ids[2] == 1))) || ((((__cs_local_check_size == 3) && (__cs_local_check_ids[3] == 1)) && (__cs_local_check_ids[0] == 1)) && (__cs_local_check_ids[1] == 1))) || (((__cs_local_check_size == 2) && (__cs_local_check_ids[0] == 1)) && (__cs_local_check_ids[3] == 1))) || ((((__cs_local_check_size == 3) && (__cs_local_check_ids[3] == 1)) && (__cs_local_check_ids[1] == 1)) && (__cs_local_check_ids[2] == 1))) || (((__cs_local_check_size == 2) && (__cs_local_check_ids[3] == 1)) && (__cs_local_check_ids[2] == 1))) || ((((__cs_local_check_size == 3) && (__cs_local_check_ids[3] == 1)) && (__cs_local_check_ids[0] == 1)) && (__cs_local_check_ids[2] == 1)));
                                        __exit__check_1:
