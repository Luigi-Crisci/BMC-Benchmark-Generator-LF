 ...
 *
 *  params:
 *    -i benchmarks/benchmark_Tue_Dec_15_22:44:00_2020/benchmark_59.c, -I ../liblfds7.1.1/liblfds711/inc, --unwind 5, --cex , --debug , --rounds 3, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[9] __cs_thread_lines[3] = {496, 226, 211};
...
tthread2_0_160: IF(2,160,tthread2_0_161)
                                        __CPROVER_assume(!(__cs_local_lfds711_stack_pop___cs_dowhile_onetime_1 < 1));
                                        __exit_loop_39:
                                                                __CPROVER_assume(__cs_pc_cs[2] >= 161);
                                        ;
                                                                ;
                                        if (
                                        !(__cs_local_lfds711_stack_pop_result == 0))
