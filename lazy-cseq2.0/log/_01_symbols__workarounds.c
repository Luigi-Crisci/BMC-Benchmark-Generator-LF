...
Variables:
   (global)
      ...
      id239  'ATOMIC_OPERATION'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[1332, 1334, 1345, 1347]'  
      id240  'lock'  
         type 'pthread_mutex_t'  kind 'g'  arity '0'  
         size '[]'  
         ref '[1332, 1334, 1345, 1347, 1354]'  
         deref '[]'  
         occurs '[1332, 1334, 1345, 1347, 1354]'  
   ...
   contains
      ...
      id232  'actual_size'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[1287, 1299, 1300, 1302, 1307]'  
      id233  'res'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
