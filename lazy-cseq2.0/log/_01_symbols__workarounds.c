...
Variables:
   (global)
      ...
      id171  'ss'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[1362, 1365, 1370, 1373, 1380, 1388]'  
      id172  'se'  
      ...
      id174  'library_lock'  
         ...
         size '[]'  
         ref '[1061, 1068, 1080, 1104, 1105, 1124, 1126, 1132, 1133, 1173, 1176, 1182, 1184]'  
         deref '[]'  
         occurs '[1061, 1068, 1080, 1104, 1105, 1124, 1126, 1132, 1133, 1173, 1176, 1182, 1184]'  
      id222  'mystack'  
         type 'struct lfds711_stack_state'  kind 'g'  arity '0'  
         size '[]'  
         ref '[1252, 1253, 1268]'  
         deref '[]'  
         occurs '[1252, 1253, 1268]'  
      id253  'ATOMIC_OPERATION'  
         type 'volatile int'  kind 'g'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[1361, 1363, 1364, 1366, 1369, 1371, 1372, 1374]'  
      id254  'lock'  
         type 'pthread_mutex_t'  kind 'g'  arity '0'  
         size '[]'  
         ref '[1361, 1363, 1364, 1366, 1369, 1371, 1372, 1374, 1379]'  
         deref '[]'  
         occurs '[1361, 1363, 1364, 1366, 1369, 1371, 1372, 1374, 1379]'  
   check
      id0  'ss'  
         type 'void *'  kind 'p'  arity '0'  
         size '[]'  
   ...
   exponential_backoff
      id175  'loop'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[1024, 1024, 1024]'  
   __VERIFIER_atomic_swap_stack_top
      id176  'top'  
         type 'struct lfds711_stack_element * volatile *'  kind 'p'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[1031, 1033, 1038]'  
         occurs '[1031, 1033, 1038]'  
      id177  'oldtop'  
         type 'struct lfds711_stack_element * volatile *'  kind 'p'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   lfds711_misc_internal_backoff_init
      id179  'bs'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[1047, 1048, 1050, 1051, 1052, 1053, 1054]'  
      id180  'c'  
   ...
   lfds711_stack_init_valid_on_current_logical_core
      id181  'ss'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[1063, 1064, 1065, 1069, 1070, 1072, 1074, 1075]'  
      id182  'user_state'  
         type 'void *'  kind 'p'  arity '0'  
         size '[]'  
         ref '[]'  
      ...
      id183  'c'  
         ...
         size '[]'  
         ref '[]'  
         deref '[1063, 1064, 1065]'  
         occurs '[1063, 1064, 1065]'  
   lfds711_stack_pop
      id184  'ss'  
         type 'struct lfds711_stack_state *'  kind 'p'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[1097, 1107, 1108, 1125]'  
      id185  'se'  
         type 'struct lfds711_stack_element **'  kind 'p'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[1116, 1140]'  
         occurs '[1098, 1116, 1140]'  
      id186  'result'  
         type 'char unsigned'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[1125, 1128, 1138, 1144]'  
      ...
      id188  'new_top'  
         ...
         ref '[1125]'  
         deref '[]'  
         occurs '[1120, 1121, 1125]'  
      id189  'original_top'  
         type 'struct lfds711_stack_element * volatile'  kind 'l'  arity '1'  
         size '[2]'  
         ref '[1125]'  
         deref '[]'  
         occurs '[1107, 1108, 1114, 1120, 1121, 1125, 1140]'  
      id190  'c'  
         type 'char *'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   lfds711_stack_push
      id192  'ss'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[1159, 1164, 1165, 1183]'  
      id193  'se'  
         type 'struct lfds711_stack_element *'  kind 'p'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[1160, 1162, 1175]'  
      id194  'result'  
         type 'char unsigned'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[1167, 1169, 1183, 1186]'  
      ...
      id196  'new_top'  
         ...
         ref '[1183]'  
         deref '[]'  
         occurs '[1162, 1179, 1183]'  
      id197  'original_top'  
         type 'struct lfds711_stack_element * volatile'  kind 'l'  arity '1'  
         size '[2]'  
         ref '[1183]'  
         deref '[]'  
         occurs '[1164, 1165, 1175, 1179, 1183]'  
      id198  'c'  
         type 'char *'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   contains
      ...
      id235  'actual_size'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[1295, 1296, 1296, 1297, 1300, 1300, 1305]'  
      id236  'res'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[1287, 1290, 1291]'  
      id237  'found'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[1287, 1298, 1311]'  
      id238  'dimension'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   get_size
      ...
      id244  'actual_size'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[1322, 1326, 1326, 1331, 1337]'  
      id245  'res'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[1319, 1321, 1323]'  
      id246  'dimension'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
...
Fields:
   lfds711_prng_state
      id4  'entropy'  type 'volatile lfds711_pal_uint_t'  kind 'f'  arity '0'  size '[]'  
   lfds711_prng_st_state
      id5  'entropy'  type 'lfds711_pal_uint_t'  kind 'f'  arity '0'  size '[]'  
   lfds711_misc_backoff_state
      id10  'lock'  type 'volatile lfds711_pal_uint_t'  kind 'f'  arity '0'  size '[]'  
   ...
   lfds711_queue_bmm_element
      id109  'sequence_number'  type 'volatile lfds711_pal_uint_t'  kind 'f'  arity '0'  size '[]'  
   ...
   lfds711_queue_bmm_state
      ...
      id114  'read_index'  type 'volatile lfds711_pal_uint_t'  kind 'f'  arity '0'  size '[]'  
      id115  'write_index'  type 'volatile lfds711_pal_uint_t'  kind 'f'  arity '0'  size '[]'  
   ...
   lfds711_queue_bss_state
      ...
      id128  'read_index'  type 'volatile lfds711_pal_uint_t'  kind 'f'  arity '0'  size '[]'  
      id129  'write_index'  type 'volatile lfds711_pal_uint_t'  kind 'f'  arity '0'  size '[]'  
   ...
   lfds711_queue_umm_state
      ...
      id138  'aba_counter'  type 'volatile lfds711_pal_uint_t'  kind 'f'  arity '0'  size '[]'  
