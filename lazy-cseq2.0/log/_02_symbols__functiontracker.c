...
Variables:
   ...
   contains
      ...
      id231  'actual_size'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[814, 827, 828, 828, 829, 833, 833, 836]'  
      id232  'res'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[815, 820, 822, 823]'  
      id233  'found'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[816, 820, 831, 841]'  
      id234  'dimension'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   get_size
      ...
      id240  'actual_size'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[846, 854, 859, 859, 862, 867]'  
      id241  'res'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[847, 851, 853, 855]'  
      id242  'dimension'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   dump_structure
      ...
      id252  'res'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[882, 886, 888, 889]'  
      id253  'data_structure_size'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[883, 891, 893, 893, 899]'  
      id254  'data'  
         type 'struct test_data *'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[895, 896]'  
         occurs '[894, 895, 896, 897]'  
      id255  'se'  
         type 'struct lfds711_stack_element *'  kind 'l'  arity '0'  
         size '[]'  
         ref '[888]'  
