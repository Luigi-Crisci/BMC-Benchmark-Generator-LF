...
Variables:
   (global)
      ...
      id185  'lock'  
         ...
         size '[]'  
         ref '[638, 660, 667, 691, 692, 705, 707, 711, 712, 753, 755, 757, 759, 846]'  
         deref '[]'  
         occurs '[638, 660, 667, 691, 692, 705, 707, 711, 712, 753, 755, 757, 759, 846]'  
   ...
   push
      ...
      id215  'td'  
         ...
         ref '[813, 814]'  
         deref '[]'  
         occurs '[808, 812, 813, 813, 814]'  
      id216  'loop'  
         type 'int long long unsigned'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[809, 809, 809, 812, 812, 813, 813, 814]'  
   pop
      id217  '__cs_unused'  
         type 'void *'  kind 'p'  arity '0'  
         size '[]'  
