...
Variables:
   (global)
      ...
      id171  'ss'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[897, 908, 922, 933, 943, 950]'  
      id172  'se'  
      ...
      id174  'library_lock'  
         ...
         size '[]'  
         ref '[623, 645, 652, 676, 677, 690, 692, 696, 697, 738, 740, 742, 744]'  
         deref '[]'  
         occurs '[623, 645, 652, 676, 677, 690, 692, 696, 697, 738, 740, 742, 744]'  
      id222  'mystack'  
      ...
      id253  'ATOMIC_OPERATION'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[892, 898, 903, 909, 917, 923, 928, 934]'  
      id254  'lock'  
         type 'pthread_mutex_t'  kind 'g'  arity '0'  
         size '[]'  
         ref '[894, 900, 905, 911, 919, 925, 930, 936, 942]'  
         deref '[]'  
         occurs '[894, 900, 905, 911, 919, 925, 930, 936, 942]'  
   check
      id0  'ss'  
         type 'void *'  kind 'p'  arity '0'  
         size '[]'  
   ...
   lfds711_misc_internal_backoff_init
      id179  'bs'  
         ...
         size '[]'  
         ref '[]'  
         deref '[606, 613, 614, 615, 616, 617]'  
         occurs '[599, 606, 613, 614, 615, 616, 617]'  
      id180  'c'  
         type 'char *'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[602, 609]'  
         occurs '[601, 602, 608, 609]'  
   lfds711_stack_init_valid_on_current_logical_core
      id181  'ss'  
         type 'struct lfds711_stack_state *'  kind 'p'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[631, 638, 646, 647, 648, 649, 650]'  
         occurs '[624, 631, 638, 646, 647, 648, 649, 650]'  
      id182  'user_state'  
         type 'void *'  kind 'p'  arity '0'  
         size '[]'  
         ref '[]'  
      ...
      id183  'c'  
         ...
         ref '[]'  
         deref '[627, 634, 641]'  
         occurs '[626, 627, 633, 634, 640, 641]'  
   lfds711_stack_pop
      id184  'ss'  
         type 'struct lfds711_stack_state *'  kind 'p'  arity '0'  
         size '[]'  
      ...
      id189  'original_top'  
         ...
         ref '[691]'  
         deref '[689]'  
         occurs '[678, 679, 683, 688, 689, 691, 707]'  
      id190  'c'  
         type 'char *'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[665, 672]'  
         occurs '[664, 665, 671, 672]'  
      id191  'i'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   lfds711_stack_push
      ...
      id197  'original_top'  
         ...
         ref '[743]'  
         deref '[]'  
         occurs '[732, 733, 739, 741, 743]'  
      id198  'c'  
         type 'char *'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[720, 727]'  
         occurs '[719, 720, 726, 727]'  
      id199  'i'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   contains
      ...
      id235  'actual_size'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[821, 834, 835, 835, 836, 840, 840, 843]'  
      id236  'res'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   get_size
      ...
      id244  'actual_size'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[853, 861, 866, 866, 869, 874]'  
      id245  'res'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[854, 858, 860, 862]'  
      id246  'dimension'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
