...
Variables:
   (global)
      ...
      id185  'lock'  
         ...
         size '[]'  
         ref '[641, 666, 673, 700, 701, 715, 717, 721, 722, 767, 769, 771, 773, 862]'  
         deref '[]'  
         occurs '[641, 666, 673, 700, 701, 715, 717, 721, 722, 767, 769, 771, 773, 862]'  
   ...
   push
      ...
      id215  'td'  
         ...
         ref '[828, 829]'  
         deref '[]'  
         occurs '[823, 827, 828, 828, 829]'  
      id216  'loop'  
         type 'int long long unsigned'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[824, 824, 824, 827, 827, 828, 828, 829]'  
   pop
      id217  '__cs_unused'  
         type 'void *'  kind 'p'  arity '0'  
         size '[]'  
