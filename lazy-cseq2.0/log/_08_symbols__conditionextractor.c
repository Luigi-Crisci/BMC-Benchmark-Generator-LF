...
Variables:
   (global)
      ...
      id185  'lock'  
         ...
         size '[]'  
         ref '[641, 666, 673, 700, 701, 715, 717, 721, 722, 740, 742, 746, 747, 790, 792, 794, 796, 885]'  
         deref '[]'  
         occurs '[641, 666, 673, 700, 701, 715, 717, 721, 722, 740, 742, 746, 747, 790, 792, 794, 796, 885]'  
   ...
   push
      ...
      id216  'td'  
         ...
         ref '[851, 852]'  
         deref '[]'  
         occurs '[846, 850, 851, 851, 852]'  
      id217  'loop'  
         type 'int long long unsigned'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[847, 847, 847, 850, 850, 851, 851, 852]'  
   pop
      id218  '__cs_unused'  
         type 'void *'  kind 'p'  arity '0'  
         size '[]'  
