...
Variables:
   (global)
      ...
      id240  'ATOMIC_OPERATION'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[903, 909, 924, 930]'  
      id241  'lock'  
         type '__cs_mutex_t'  kind 'g'  arity '0'  
         size '[]'  
         ref '[905, 911, 926, 932, 939]'  
         deref '[]'  
         occurs '[905, 911, 926, 932, 939]'  
   ...
   contains
      ...
      id233  'actual_size'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[861, 871, 878, 879, 883, 887]'  
      id234  'res'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
