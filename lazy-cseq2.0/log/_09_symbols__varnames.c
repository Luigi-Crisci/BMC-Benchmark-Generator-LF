list of functions:
   ...
   swap_stack_top(param: top, oldtop, newtop)  call count 3
...
Variables:
   (global)
      ...
      id187  'lock'  
         ...
         size '[]'  
         ref '[645, 673, 680, 709, 710, 727, 729, 734, 735, 755, 757, 762, 763, 809, 811, 813, 815, 909]'  
         deref '[]'  
         occurs '[645, 673, 680, 709, 710, 727, 729, 734, 735, 755, 757, 762, 763, 809, 811, 813, 815, 909]'  
   ...
   push
      ...
      id237  'td'  
         ...
         ref '[874, 875]'  
         deref '[]'  
         occurs '[869, 873, 874, 874, 875]'  
      id238  'loop'  
         type 'int long long unsigned'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[870, 870, 870, 873, 873, 874, 874, 875]'  
   pop
      id239  '__cs_unused'  
         type 'void *'  kind 'p'  arity '0'  
         size '[]'  
...
function: __atomic_compare_exchange_n   stmt:     if (__cs_tmp_if_cond_0)
    {
        *mptr = newval;
        return 1;
    }
...
function: swap_stack_top   stmt:     if (__cs_tmp_if_cond_1)
    {
        *top = *newtop;
        return 1;
    }
...
function: pop   stmt:     __CSEQ_assert(count == 3);
