...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_3; }
                                                {
;
                                                }
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_4; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_5; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_lfds711_stack_push_i;
__cs_local_lfds711_stack_push_i = 0;
                                                if(!(__cs_local_lfds711_stack_push_result == 0)) { goto __exit_loop_6; }
                        {
__cs_mutex_lock(&lock);
(*__cs_param_lfds711_stack_push_se).next = __cs_local_lfds711_stack_push_original_top[0];
__cs_mutex_unlock(&lock);
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_7; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_8; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_9; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
goto __exit_loop_6; 
                        ...
                        __CSEQ_assume(!(__cs_local_lfds711_stack_push_result == 0)); __exit_loop_6: ;
...
static int __cs_local_lfds711_stack_push_i;
__cs_local_lfds711_stack_push_i = 0;
                                                if(!(__cs_local_lfds711_stack_push_result == 0)) { goto __exit_loop_10; }
                        {
__cs_mutex_lock(&lock);
(*__cs_param_lfds711_stack_push_se).next = __cs_local_lfds711_stack_push_original_top[0];
__cs_mutex_unlock(&lock);
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_11; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_12; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_13; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
goto __exit_loop_10; 
                        ...
                        __CSEQ_assume(!(__cs_local_lfds711_stack_push_result == 0)); __exit_loop_10: ;
...
__cs_local_push_loop++;
        __CSEQ_assume(!(__cs_local_push_loop < 3)); __exit_loop_1: ;
__exit_push:
        ;
        __cs_exit(0);
}
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_16; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_18; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_19; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_20; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_22; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
__cs_local_lfds711_stack_pop___cs_dowhile_onetime_1++;
                                                __CSEQ_assume(!(__cs_local_lfds711_stack_pop___cs_dowhile_onetime_1 < 1)); __exit_loop_21: ;
                                                if(!(
__cs_local_lfds711_stack_pop_result == 0)) { goto __exit_loop_23; }
                        {
;
static _Bool __cs_local_lfds711_stack_pop___cs_tmp_if_cond_12;
__cs_local_lfds711_stack_pop___cs_tmp_if_cond_12 = __cs_local_lfds711_stack_pop_original_top[0] == 0;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_24; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_25; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_26; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
__cs_local_exponential_backoff_loop;
                                                __CSEQ_assume(!(__cs_local_exponential_backoff_loop < 10)); __exit_loop_26: ;
...
goto __exit_loop_23; 
                        ...
                        __CSEQ_assume(!(
__cs_local_lfds711_stack_pop_result == 0)); __exit_loop_23: ;
*__cs_param_lfds711_stack_pop_se = __cs_local_lfds711_stack_pop_original_top[0];
__cs_retval__lfds711_stack_pop_1 = 1;
                        goto __exit__lfds711_stack_pop_1_1;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_28; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
__cs_local_lfds711_stack_pop___cs_dowhile_onetime_1++;
                                                __CSEQ_assume(!(__cs_local_lfds711_stack_pop___cs_dowhile_onetime_1 < 1)); __exit_loop_27: ;
                                                if(!(
__cs_local_lfds711_stack_pop_result == 0)) { goto __exit_loop_29; }
                        {
;
static _Bool __cs_local_lfds711_stack_pop___cs_tmp_if_cond_12;
__cs_local_lfds711_stack_pop___cs_tmp_if_cond_12 = __cs_local_lfds711_stack_pop_original_top[0] == 0;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_30; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_31; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
static int __cs_local_exponential_backoff_loop;
                                                __cs_local_exponential_backoff_loop = 0;
                                                                                                if(!(__cs_local_exponential_backoff_loop < 10)) { goto __exit_loop_32; }
                                                {
;
                                                }
__cs_local_exponential_backoff_loop;
...
__cs_local_exponential_backoff_loop;
                                                __CSEQ_assume(!(__cs_local_exponential_backoff_loop < 10)); __exit_loop_32: ;
...
goto __exit_loop_29; 
                        ...
                        __CSEQ_assume(!(
__cs_local_lfds711_stack_pop_result == 0)); __exit_loop_29: ;
*__cs_param_lfds711_stack_pop_se = __cs_local_lfds711_stack_pop_original_top[0];
__cs_retval__lfds711_stack_pop_1 = 1;
                        goto __exit__lfds711_stack_pop_1_2;
...
__cs_local_pop_loop++;
        ...
        __CSEQ_assume(!(__cs_local_pop_loop < 3)); __exit_loop_14: ;
